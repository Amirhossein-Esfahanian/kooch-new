        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParentDestinationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Destinations_Destinations_ParentDestinationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanBeRestricted = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultNearbyPlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DefaultNearbyPlaces_Destinations_DestinationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAreaM2 = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    LandAreaM2 = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
                    FloorsCount = table.Column<int>(type: "int", nullable: true),
                    StairCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeCancellationDays = table.Column<int>(type: "int", nullable: true),
                    PenaltyPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalkingMinutes = table.Column<int>(type: "int", nullable: true),
                    DrivingMinutes = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Latitude = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: true),
                    Longitude = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "PropertyDescriptionSections",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyDescriptionSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyDescriptionSections_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyTravelPurposes", x => x.Id);
                    table.CheckConstraint("CK_PropertyTravelPurpose_Score", "[Score] IS NULL OR [Score] BETWEEN 0 AND 100");
                    table.ForeignKey(
                        name: "FK_PropertyTravelPurposes_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyTravelPurposes_TravelPurposes_TravelPurposeId",
                        column: x => x.TravelPurposeId,
                        principalTable: "TravelPurposes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "PropertyWarnings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyWarnings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyWarnings_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SeoMetadata_Target", "(CASE WHEN [PropertyId] IS NULL THEN 0 ELSE 1 END + CASE WHEN [DestinationId] IS NULL THEN 0 ELSE 1 END + CASE WHEN [PageKey] IS NULL THEN 0 ELSE 1 END) = 1");
                    table.ForeignKey(
                        name: "FK_SeoMetadata_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SeoMetadata_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    MinNightsOverride = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Promotion_Scope", "([Scope] = 0 AND [PropertyId] IS NULL AND [RoomTypeId] IS NULL) OR ([Scope] = 1 AND [PropertyId] IS NOT NULL AND [RoomTypeId] IS NULL) OR ([Scope] = 2 AND [PropertyId] IS NULL AND [RoomTypeId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    PriceModifierType = table.Column<int>(type: "int", nullable: false),
                    PriceModifierValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MinimumNights = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RatePlans_MealPlans_MealPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPrivateBathroom = table.Column<bool>(type: "bit", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StayRule_Scope", "([PropertyId] IS NULL AND [RoomTypeId] IS NOT NULL) OR ([PropertyId] IS NOT NULL AND [RoomTypeId] IS NULL)");
                    table.ForeignKey(
                        name: "FK_StayRules_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StayRules_RoomTypes_RoomTypeId",
                        column: x => x.RoomTypeId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IsCover = table.Column<bool>(type: "bit", nullable: false),
                    IsGallery = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByUserId = table.Column<int>(type: "int", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedByUserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraGuestAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    GuestNote = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    HoldUntilUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Review_DetailedRatings", "([CleanlinessRating] IS NULL OR [CleanlinessRating] BETWEEN 1 AND 5) AND ([LocationRating] IS NULL OR [LocationRating] BETWEEN 1 AND 5) AND ([StaffRating] IS NULL OR [StaffRating] BETWEEN 1 AND 5) AND ([ValueRating] IS NULL OR [ValueRating] BETWEEN 1 AND 5)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amenities_AmenityCategoryId_SortOrder",
                table: "Amenities",
                columns: new[] { "AmenityCategoryId", "SortOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityCategories_Slug",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DefaultNearbyPlaces_DestinationId_Title",
                table: "DefaultNearbyPlaces",
                columns: new[] { "DestinationId", "Title" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Destinations_ParentDestinationId",
                table: "Destinations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPlans_Slug",
                table: "MealPlans",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NearbyPlaces_PropertyId_Category",
                table: "NearbyPlaces",
                columns: new[] { "PropertyId", "Category" });

            migrationBuilder.CreateIndex(
                name: "IX_NearbyPlaces_PropertyId_Title",
                table: "NearbyPlaces",
                columns: new[] { "PropertyId", "Title" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyDescriptionSections_PropertyId_SectionType_SortOrder",
                table: "PropertyDescriptionSections",
                columns: new[] { "PropertyId", "SectionType", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_PropertyHighlights_PropertyId_Slug",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyTravelPurposes_PropertyId_TravelPurposeId",
                table: "PropertyTravelPurposes",
                columns: new[] { "PropertyId", "TravelPurposeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PropertyTravelPurposes_TravelPurposeId",
                table: "PropertyTravelPurposes",
                column: "TravelPurposeId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyWarnings_PropertyId",
                table: "PropertyWarnings",
                column: "PropertyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTypeBeds_RoomTypeId_BedTypeId",
                table: "RoomTypeBeds",
                columns: new[] { "RoomTypeId", "BedTypeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeoMetadata_DestinationId",
                table: "SeoMetadata",
                column: "DestinationId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "PageKey",
                unique: true,
                filter: "[PageKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_SeoMetadata_PropertyId",
                table: "SeoMetadata",
                column: "PropertyId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StayRules_PropertyId",
                table: "StayRules",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_StayRules_RoomTypeId",
                table: "StayRules",
                column: "RoomTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelPurposes_Slug",
                table: "TravelPurposes",
                column: "Slug",
                unique: true);
