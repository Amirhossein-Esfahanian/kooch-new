...
internal static class ReservationOwnerApprovalReminderSettings
{
    internal const string SettingKey = "reservation.ownerApprovalReminderIntervalMinutes";
    internal const int DefaultMinutes = 3;
