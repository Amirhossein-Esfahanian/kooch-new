  ...
  return (
    <section className="relative overflow-hidden px-5 pb-20 pt-14 sm:px-8 sm:pb-28 sm:pt-20">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <p className="mb-5 text-xs font-bold uppercase tracking-[0.28em] text-coral">
          ...
          <h1 className="max-w-3xl text-5xl font-bold leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:text-7xl">
            Find a place worth <span className="text-moss">slowing down</span>{" "}
            for.
          </h1>
          <p className="mt-7 max-w-xl text-base leading-7 text-ink/65 sm:text-lg">
            From quiet cabins to sunlit city homes, Kooch brings together stays
            with a sense of place.
          </p>
          <div className="mt-9 flex flex-wrap gap-4">
            <Link
              href="/stays"
              className="rounded-full bg-ink px-7 py-3.5 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-moss motion-reduce:hover:translate-y-0"
            >
              Explore all stays
            </Link>
            <a
              href="#featured"
              className="rounded-full border border-ink/20 px-7 py-3.5 text-sm font-bold transition hover:border-ink hover:bg-white/40"
            >
              See our picks
            </a>
          </div>
