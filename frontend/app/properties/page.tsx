...
const filterGroups = [
  ...
  { title: "نوع رزرو", items: ["رزرو آنی", "نیازمند تأیید"] },
...
export default function PropertiesPage() {
  return <Suspense fallback={<PageLoading />}><PropertiesContent /></Suspense>;
}
...
function PropertiesContent() {
  ...
  function search(event: FormEvent<HTMLFormElement>) {
    ...
    const query = new URLSearchParams({ city, adults: Math.max(1, adults).toString() });
